...
#define TIMER_RATE_PATH "/timer_rate"
#define TIMER_SLACK_PATH "/timer_slack"
#define MIN_SAMPLE_TIME_PATH "/min_sample_time"
#define GO_HIGHSPEED_LOAD_PATH "/go_hispeed_load"
#define TARGET_LOADS_PATH "/target_loads"
#define ABOVE_HIGHSPEED_DELAY_PATH "/above_hispeed_delay"
#define BOOSTPULSE_DURATION_PATH "/boostpulse_duration"
...
{
    cpu_interactive_write(TIMER_RATE_PATH, "20000");
    cpu_interactive_write(TIMER_SLACK_PATH, "20000");
    cpu_interactive_write(MIN_SAMPLE_TIME_PATH, "40000");
    cpu_interactive_write(GO_HIGHSPEED_LOAD_PATH, "89");
    cpu_interactive_write(TARGET_LOADS_PATH, "75 1200000:85");
    cpu_interactive_write(ABOVE_HIGHSPEED_DELAY_PATH, "39000 1200000:19000");
    cpu_interactive_write(BOOSTPULSE_DURATION_PATH, "40000");
    cpu_interactive_write(HISPEED_FREQ_PATH, "900000");
...
struct samsung_power_module HAL_MODULE_INFO_SYM = {
    .base = {
        .common = {
            ...
            .name = "Samsung a3xelte Power HAL",
            .author = "The 7580 Project",
